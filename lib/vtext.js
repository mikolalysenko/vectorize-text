...
function getPixels(canvas, context, raw_str, fontSize, breakLines, lineSpacing) {

  raw_str = raw_str.replace(/\n/g, '') // don't accept \n in the input

  if (breakLines === false) {
    raw_str = raw_str.replace(/\<br\>/g, ' ') // don't accept <br> tags in the input and replace with space in this case
  } else {
...
function vectorizeText(str, canvas, context, options) {
  ...
  var breakLines = true
  if (options.breakLines === false) breakLines = false
  ...
  var pixels = getPixels(canvas, context, str, size, breakLines, lineSpacing)
