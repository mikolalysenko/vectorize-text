...
function vectorizeText(str, canvas, context, options) {
  ...
  var styletags = {
      breaklines: (options.styletags.breaklines   === false) ? false : true,
           bolds: (options.styletags.bolds        === false) ? false : true,
         italics: (options.styletags.italics      === false) ? false : true,
      subscripts: (options.styletags.subscripts   === false) ? false : true,
    superscripts: (options.styletags.superscripts === false) ? false : true
  }
